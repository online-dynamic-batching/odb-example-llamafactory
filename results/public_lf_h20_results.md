...
These are example run records for the public MM-Mix LLaMA-Factory example.
They are not exact reproductions of the paper's MM-Mix data or paper-number
...
They are kept together only to document available public LLaMA-Factory example
runs.
