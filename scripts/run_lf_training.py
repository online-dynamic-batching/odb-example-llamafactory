...
def _prepare_config(args: argparse.Namespace) -> Path:
    ...
    if args.loader == "odb":
        ...
        # This setting belongs to older experiment forks. The public
        # LLaMA-Factory hook sets the worker sharing strategy in code, so keep
        # the generated YAML compatible with the current hparams parser.
